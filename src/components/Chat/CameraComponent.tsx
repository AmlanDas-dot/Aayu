...
export function CameraComponent({ isOpen, onClose, onCapture }: CameraComponentProps) {
  ...
  const handleCapture = () => {
    ...
    // Use video dimensions for canvas size
          ...
          {errorMessage ? (
            ...
            <>
              ...
              <button
                ...
                onMouseOver={(e) => !isInitializing && (e.currentTarget.style.transform = "scale(1.08)")}
                onMouseOut={(e) => !isInitializing && (e.currentTarget.style.transform = "scale(1)")}
              >
