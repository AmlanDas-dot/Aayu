...
new_code = """import React, { useState, useRef, useMemo } from 'react';
...
with open(r"d:\Aayu\src\features\nutrition\components\NutritionLogWidget.tsx", "w", encoding="utf-8") as f:
    f.write(new_code)
print("Updated NutritionLogWidget.tsx successfully.")
